...
func (itr *bufBooleanIterator) NextBatch() ([]*BooleanPoint, error) {
...
func (itr *booleanMergeIterator) NextBatch() ([]*BooleanPoint, error) {
	results := make([]*BooleanPoint, 0)
	itr.mu.RLock()
...
func (itr *booleanSortedMergeIterator) NextBatch() ([]*BooleanPoint, error) {
	p, err := itr.pop()
	results := make([]*BooleanPoint, 0)
	results = append(results, p)
	return results, err
...
func (itr *booleanParallelIterator) NextBatch() ([]*BooleanPoint, error) {
	v, ok := <-itr.ch
	results := make([]*BooleanPoint, 0)
	if !ok {
...
func (itr *booleanLimitIterator) NextBatch() ([]*BooleanPoint, error) {
	results := make([]*BooleanPoint, 0)
	for {
...
func (itr *booleanFillIterator) NextBatch() ([]*BooleanPoint, error) {
	results := make([]*BooleanPoint, 0)
	if !itr.init {
...
func (itr *booleanIntervalIterator) NextBatch() ([]*BooleanPoint, error) {
	results := make([]*BooleanPoint, 0)
	p, err := itr.input.Next()
	if p == nil || err != nil {
		return results, err
...
func (itr *booleanInterruptIterator) NextBatch() ([]*BooleanPoint, error) {
...
func (itr *booleanCloseInterruptIterator) NextBatch() ([]*BooleanPoint, error) {
	results := make([]*BooleanPoint, 0)
	p, err := itr.input.Next()
	if err != nil {
...
func (itr *booleanReduceFloatIterator) NextBatch() ([]*FloatPoint, error) {
...
func (itr *booleanStreamFloatIterator) NextBatch() ([]*FloatPoint, error) {
	results := make([]*FloatPoint, 0)
	// Calculate next window if we have no more points.
	if len(itr.points) == 0 {
		var err error
...
func (itr *booleanReduceIntegerIterator) NextBatch() ([]*IntegerPoint, error) {
...
func (itr *booleanStreamIntegerIterator) NextBatch() ([]*IntegerPoint, error) {
	results := make([]*IntegerPoint, 0)
	// Calculate next window if we have no more points.
	if len(itr.points) == 0 {
		var err error
...
func (itr *booleanReduceUnsignedIterator) NextBatch() ([]*UnsignedPoint, error) {
...
func (itr *booleanStreamUnsignedIterator) NextBatch() ([]*UnsignedPoint, error) {
	results := make([]*UnsignedPoint, 0)
	// Calculate next window if we have no more points.
	if len(itr.points) == 0 {
		var err error
...
func (itr *booleanReduceStringIterator) NextBatch() ([]*StringPoint, error) {
...
func (itr *booleanStreamStringIterator) NextBatch() ([]*StringPoint, error) {
	results := make([]*StringPoint, 0)
	// Calculate next window if we have no more points.
	if len(itr.points) == 0 {
		var err error
...
func (itr *booleanReduceBooleanIterator) NextBatch() ([]*BooleanPoint, error) {
	results := make([]*BooleanPoint, 0)
	// Calculate next window if we have no more points.
	if len(itr.points) == 0 {
		var err error
...
func (itr *booleanStreamBooleanIterator) NextBatch() ([]*BooleanPoint, error) {
	results := make([]*BooleanPoint, 0)
	// Calculate next window if we have no more points.
	if len(itr.points) == 0 {
		var err error
...
func (itr *booleanIteratorMapper) NextBatch() ([]*BooleanPoint, error) {
	results := make([]*BooleanPoint, 0)
...
func (itr *booleanFilterIterator) NextBatch() ([]*BooleanPoint, error) {
	results := make([]*BooleanPoint, 0)
	for {
		p, err := itr.input.Next()
		if err != nil || p == nil {
...
func (itr *booleanDedupeIterator) NextBatch() ([]*BooleanPoint, error) {
	results := make([]*BooleanPoint, 0)
	for {
		// Read next point.
		p, err := itr.input.Next()
...
func (itr *booleanReaderIterator) NextBatch() ([]*BooleanPoint, error) {
