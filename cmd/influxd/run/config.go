...
type Config struct {
	...
	//(TODO shan.jt for cluster) add proxy config
	//Proxy *meta.ProxyConfig					`toml:"proxy"`
	RaftConfig *meta.RaftConfig `toml:"raft"`
}
...
func NewConfig() *Config {
	...
	//c.Proxy = meta.NewProxyConfig()
	c.RaftConfig = meta.NewRaftConfig()
...
func (c *Config) Validate() error {
	...
	//TODO(shan.jt for cluster) Validata proxy config
